...
def test_record_backtest_result_updates_record_file_and_readme(tmp_path):
    ...
    record = BacktestRecord(
        ...
        win_rate="50.0%",
        trade_count="2",
        chart="[チャート](assets/backtests/6976_2026-07-10_combined_normal_chart.html)",
    ...
    assert "[チャート](docs/assets/backtests/6976_2026-07-10_combined_normal_chart.html)" in readme_text
